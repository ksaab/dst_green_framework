...
local questName = "_ex_bring_five_rocks"
local requredItem = "rocks"
...
local Quest = Class(GFQuest, function(self)
    ...
    --strings
    self.title = "Rocks are good"
    self.description = "Smash spders. Need rocks. Big."
    self.completion = "You good. Spider bad."
    self.goaltext = "Bring 5 rocks"
