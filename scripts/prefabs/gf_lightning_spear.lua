...
local function onequip(inst, owner)
    owner.AnimState:OverrideSymbol("swap_object", "swap_gf_lightning_spear", "swap_gf_lightning_spear")
...
local function fn()
    ...
    inst.AnimState:SetBank("gf_lightning_spear")
    inst.AnimState:SetBuild("gf_lightning_spear")
    inst.AnimState:PlayAnimation("idle")

    inst:AddTag("sharp")
    inst:AddTag("pointy")
    inst:AddTag("spearlunge")
...
return Prefab("gf_lightning_spear", fn, assets)
